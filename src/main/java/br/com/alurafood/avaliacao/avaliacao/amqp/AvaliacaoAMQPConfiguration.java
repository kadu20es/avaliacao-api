...
public class AvaliacaoAMQPConfiguration {
    ...
    public Queue filaDetalhesAvaliacao() {
        return QueueBuilder
                ...
                .deadLetterExchange("pagamentos.dlx") // aponta a exchange de mensagens mortas da fila filaDetalhesAvaliacao
                .build();
    }

    @Bean
    public Queue filaDeadLetterQueue() {
        return QueueBuilder
